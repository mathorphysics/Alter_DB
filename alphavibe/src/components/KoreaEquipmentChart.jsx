    ...
    <div className="bg-[#161b22] border border-[#21262d] rounded-lg p-4">
      ...
      {!compact && data && last && (
        <div className="flex gap-4 mb-3">
          <div>
            <span className="text-[10px] text-[#8b949e]">NL → KR</span>
          ...
          <div>
            <span className="text-[10px] text-[#8b949e]">US → KR</span>
          ...
          <div>
            ...
            <div className="text-[11px] text-[#484f58]">UN Comtrade · HS 848620</div>
          </div>
        </div>
      )}
