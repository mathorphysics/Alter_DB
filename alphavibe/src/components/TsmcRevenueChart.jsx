    ...
    <div className="bg-[#161b22] border border-[#21262d] rounded-lg p-4">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#e6edf3]">TSMC Monthly Revenue</h3>
            <p className="text-[11px] text-[#8b949e]">NT$ Millions · investor.tsmc.com</p>
          </div>
      ...
      {data && last && (
        <div className="flex gap-4 mb-3">
          <div>
            <span className="text-[10px] text-[#8b949e]">Latest ({last.label})</span>
          ...
          <div>
            <span className="text-[10px] text-[#8b949e]">Period</span>
