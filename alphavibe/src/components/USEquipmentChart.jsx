...
import { fetchUSEquipmentExports } from '../api/altdata';
...
const SERIES = [
  { key: 'Taiwan', name: 'US → TW', color: '#34d399' },
  { key: 'Korea',  name: 'US → KR', color: '#467897' },
  { key: 'China',  name: 'US → CN', color: '#f87171' },
];
...
export default function USEquipmentChart({ compact = false }) {
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-semibold text-[var(--fg)]">
              US Semiconductor Equipment Exports
            </h3>
            {!compact && (
              <p className="text-[11px] text-[var(--sub)]">
                HS-848620 exports to TW / KR / CN — AMAT / Lam / KLA proxy · USD Millions · UN Comtrade
              </p>
            )}
          </div>
